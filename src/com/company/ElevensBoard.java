...
public class ElevensBoard {
    ...
    public boolean anotherPlayIsPossible() {
        ...
        {
            if((cards[i-2].getValue() == 11) && (cards[i-1].getValue() == 12) &&(cards[i].getValue() == 13) )
            {
                return true;
            }
            if((cards[i-2].getValue() == 11) && (cards[i-1].getValue() == 13) &&(cards[i].getValue() == 12) )
            {
                return true;
            }
            if((cards[i-2].getValue() == 12) && (cards[i-1].getValue() == 13) &&(cards[i].getValue() == 11) )
            {
                return true;
            }
            if((cards[i-2].getValue() == 12) && (cards[i-1].getValue() == 12) &&(cards[i].getValue() == 13) )
            {
                return true;
            }
            if((cards[i-2].getValue() == 13) && (cards[i-1].getValue() == 11) &&(cards[i].getValue() == 12) )
            {
                return true;
            }
            if((cards[i-2].getValue() == 13) && (cards[i-1].getValue() == 12) &&(cards[i].getValue() == 11) )
            {
                return true;
            }
            for(int j = i - 1; j < i; j++)
            {
                if((cards[j-1].getValue() + cards[j].getValue()) == 11)
                {
                    return true;
                }
            }
    ...
    private boolean containsPairSum11(List<Integer> selectedCards) {
        ...
        {
            if((cards[selectedCards.get(i)].getValue() + cards[selectedCards.get(i+1)].getValue()) == 11)
            {
                return true;
            }
        }
